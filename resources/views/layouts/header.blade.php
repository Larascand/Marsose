<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div id="logo" class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <a href="../../demo39/dist/index.html" class="app-sidebar-logo">
                <img alt="Logo" src="assets/media/logos/logo-marsose.svg" class="h-25px theme-light-show"/>
            </a>
            <!--end::Logo-->
        </div>
        <!--begin::Navbar-->
